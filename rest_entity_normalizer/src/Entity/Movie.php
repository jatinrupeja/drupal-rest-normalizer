...
namespace Drupal\rest_entity_normalizer\Entity;
...
use Drupal\rest_entity_normalizer\MovieInterface;
 ...
 *   handlers = {
 *     "view_builder" = "Drupal\rest_entity_normalizer\MovieViewBuilder",
 *     "list_builder" = "Drupal\rest_entity_normalizer\MovieListBuilder",
 *     "views_data" = "Drupal\views\EntityViewsData",
 *     "form" = {
 *       "add" = "Drupal\rest_entity_normalizer\Form\MovieForm",
 *       "edit" = "Drupal\rest_entity_normalizer\Form\MovieForm",
...
class Movie extends ContentEntityBase implements MovieInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['uid'] = BaseFieldDefinition::create('entity_reference')
      ->setLabel(t('Author'))
      ->setDescription(t('The user ID of the movie author.'))
